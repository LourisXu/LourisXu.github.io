---
title: WorkSheet
translate_title: worksheet
tags:
  - Essay
date: 2019-05-18 09:29:30
---


|Work|Date|
|:----|:----:|
|[Install dependency Libraries](https://github.com/parisots/population-gcn)|2019.05.08--05.09|
|[Learn the Python](https://www.liaoxuefeng.com/wiki/1016959663602400)(The chapters before GUI)<br> 算法笔记：Prim、Kruskal、拓扑排序、关键路径 |2019.05.10--05.17|
...
[Conda Guid](https://docs.conda.io/projects/conda/en/latest/index.html)
...
[Tensorflow](https://github.com/tensorflow/tensorflow?tdsourcetag=s_pctim_aiomsg)
```
...
**基于数据的统计学研究，周而复始，却又不同，数据间还隐藏着什么秘密呢？**
